...
(function()
 {
	...
	freeboard.loadDatasourcePlugin({
                                   ...
                                   "settings"    : [
                                                    ...
                                                    {
                                                    "name"        : "send_message",
                                                    "display_name": "Send Connect Message",
                                                    "type"        : "boolean",
                                                    "description" : "Send MQTT message when connect",
                                                    "default_value": false
                                                    },
                                                    {
                                                    "name"        : "send_topic",
                                                    "display_name": "MQTT send topic",
                                                    "type"        : "text",
                                                    "default_value": "/dash",
                                                    "required"    : false
                                                    },
                                                    ...
                                                    "display_name": "Connection message",
                                                    "type"        : "text",
                                                    "default_value": "Dash Connected!",
                                                    "required"    : false
                                                    },
                                                    {
                                                    "name"        : "client_id",
 ...
 if (currentSettings.send_message) {
    self.send(currentSettings.connect_message,currentSettings.send_topic);
    console.log("Connection message is sent");
}
 };
...
self.send = function(value,topicSend) {
